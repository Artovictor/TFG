function blade = iea15MWBladeMod
%



%%He modificado wt_dirs.m para añadir esta función%%
%%He cambiado la id de la 15MW vanilla porque estaba mal%%
...
% });
% ndb   = blade2ndBlade(b);
% plotNdBlade(ndb,{'IEA-15Mod'});
%
%% References 
%
%  [1] Gaertner, Evan, Jennifer Rinker, Latha Sethuraman, Frederik Zahle, 
%      Benjamin Anderson, Garrett Barter, Nikhar Abbas, Fanzhong Meng, 
%      Pietro Bortolotti, Witold Skrzypinski, George Scott, Roland Feil, 
%      Henrik Bredmose, Katherine Dykes, Matt Shields, Christopher Allen, 
%      and Anthony Viselli. 2020. Definition of the IEA 15-Megawatt 
%      Offshore Reference Wind. Golden, CO: National Renewable Energy 
%      Laboratory. NREL/TP-5000-75698.
%      https://www.nrel.gov/docs/fy20osti/75698.pdf
%  [2] IEA-15-240-RWT_tabular.xlsx excel file. 
